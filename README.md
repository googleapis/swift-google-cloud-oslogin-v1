...
Add `swift-google-cloud-oslogin-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-oslogin-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudOSLoginV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudOSLoginV1 <target-name> --package swift-google-cloud-oslogin-v1
```
